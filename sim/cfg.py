...
# cfg.duration        = 10 + cfg.skipTime              # Duration of the simulation, in ms
...
# cfg.select_microcircuit = 2     # testing post SfN (2023-11-22)
...
# # --- Gids from filtered morphologies
# # [33664, 33908, 39168, 41337]
# cfg.target = 'VPL_TC'
# gids=[41337] ; # ----------------------> best cell
# # gids=[33664] ; 
# # gids=[33908] ; 
# # gids=[39168] ; 
...
# gids=[36636] ; 
# cfg.hParams['v_init']=-75.85079 ; 
# iclamp_amp = 0.000 # 0.0061 # 0.0068 # 0.0072 # 0.008 # 0.01 # 0.03 # 0.061 # 'VPL_TC'     # RMP properties:   0 mA: -76 mV | 0.01 mA: -74.28 mV | 0.02 mA: -72.7 mV | 0.05 mA: -68.5 mV | 0.075 mA: -66.03 mV | 0.08 mA: -65.47 mV | 0.0825 mA: -65.2 mV | 0.084 mA: -65.04 mV | 0.1 mA: -63 mV | 
...
cfg.target = 'Rt_RC'
gids=[31571]      ; 
cfg.hParams['v_init']=-71.4145 ; 
iclamp_amp = 0.04056 # 0.04054 # 0.040535 # 0.04053 # 0.0405 # 0.038 # 0.041 # 0.045
# cfg.duration = 5100
...
if cfg.connType == 'original':
    ...
    if len(cfg.select_thal_gids)==1:
        outputName = 'nrn-7-8-2_postSfN_tests_'+cfg.target+'__'+str(cfg.select_thal_gids[0])+saveFigFlag
    else:
        c_name=''
